			...
			<div className="max-w-2xl mx-auto">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-6">
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:deffnerconnor@gmail.com"
					...
					<div className="flex justify-center gap-6">
						<a href="https://github.com/Connor2452" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
						...
						<a href="https://linkedin.com/in/connor-deffner-951115292" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
							<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
