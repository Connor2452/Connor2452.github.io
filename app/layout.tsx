...
export const metadata: Metadata = {
	title: 'Connor Deffner - Developer',
	description:
	...
	authors: [{ name: 'Connor Deffner' }],
	creator: 'Connor Deffner',
	openGraph: {
		title: 'Connor Deffner - Developer Portfolio',
		...
		siteName: 'Connor Deffner - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Connor Deffner - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
